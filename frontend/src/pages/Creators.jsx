      ...
      {creators.map((creator) => (
        ...
        >
          ...
          <div className="px-4 py-6 mt-4">
            ...
            <p className="text-center text-gray-700 mt-2">{creator.email}</p>
            <p className="text-center text-gray-700 mt-2">{creator.phone}</p>
            <p className="text-center text-gray-700 mt-2">{creator.role}</p>
          </div>
        </div>
      ))}
    </div>
