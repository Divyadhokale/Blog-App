      ...
      <nav className=" shadow-lg px-4 py-2">
        <div className="flex items-center justify-between container mx-auto">
          <div className="font-semibold text-xl">
            Blog<span className="text-pink-500">iFy</span>
          </div>
          {/* Desktop */}
          <div className=" mx-6">
          ...
          <div className="hidden md:flex space-x-2">
            {isAuthenticated && profile?.user?.role === "admin" ? (
              <Link
                to="/dashboard"
                className="bg-pink-600 text-white font-semibold hover:bg-pink-800 duration-300 px-4 py-2 rounded"
              >
                DASHBOARD
              </Link>
            ) : (
            ...
            {!isAuthenticated ? (
              <Link
                to="/Login"
                className="bg-pink-600 text-white font-semibold hover:bg-red-800 duration-300 px-4 py-2 rounded"
              >
                LOGIN
              </Link>
            ) : (
